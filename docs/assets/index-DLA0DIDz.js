...
`)+`
`+f);const v=M+d+o,x=M+f+a,R=xc(r,r.VERTEX_SHADER,v),w=xc(r,r.FRAGMENT_SHADER,x);r.attachShader(_,R),r.attachShader(_,w),t.index0AttributeName!==void 0?r.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function C(L){if(i.debug.checkShaderErrors){const N=r.getProgramInfoLog(_)||"",V=r.getShaderInfoLog(R)||"",I=r.getShaderInfoLog(w)||"",F=N.trim(),K=V.trim(),j=I.trim();let G=!0,ce=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(G=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,_,R,w);else{const pe=Sc(r,R,"vertex"),xe=Sc(r,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
...
}`;function Ng(i,e,t){let n=new ta;const r=new de,s=new de,o=new ht,a=new rf({depthPacking:Su}),l=new sf,c={},u=t.maxTextureSize,h={[Fn]:Rt,[Rt]:Fn,[xn]:xn},p=new An({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new de},radius:{value:4}},vertexShader:Ig,fragmentShader:Ug}),m=p.clone();m.defines.HORIZONTAL_PASS=1;const g=new xt;g.setAttribute("position",new It(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new Et(g,p),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Uc;let f=this.type;this.render=function(w,C,P){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||w.length===0)return;const E=i.getRenderTarget(),y=i.getActiveCubeFace(),L=i.getActiveMipmapLevel(),N=i.state;N.setBlending(Un),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const V=f!==vn&&this.type===vn,I=f===vn&&this.type!==vn;for(let F=0,K=w.length;F<K;F++){const j=w[F],G=j.shadow;if(G===void 0){console.warn("THREE.WebGLShadowMap:",j,"has no shadow.");continue}if(G.autoUpdate===!1&&G.needsUpdate===!1)continue;r.copy(G.mapSize);const ce=G.getFrameExtents();if(r.multiply(ce),s.copy(G.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/ce.x),r.x=s.x*ce.x,G.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/ce.y),r.y=s.y*ce.y,G.mapSize.y=s.y)),G.map===null||V===!0||I===!0){const xe=this.type!==vn?{minFilter:zt,magFilter:zt}:{};G.map!==null&&G.map.dispose(),G.map=new ei(r.x,r.y,xe),G.map.texture.name=j.name+".shadowMap",G.camera.updateProjectionMatrix()}i.setRenderTarget(G.map),i.clear();const pe=G.getViewportCount();for(let xe=0;xe<pe;xe++){const le=G.getViewport(xe);o.set(s.x*le.x,s.y*le.y,s.x*le.z,s.y*le.w),N.viewport(o),G.updateMatrices(j,xe),n=G.getFrustum(),x(C,P,G.camera,j,this.type)}G.isPointLightShadow!==!0&&this.type===vn&&M(G,P),G.needsUpdate=!1}f=this.type,d.needsUpdate=!1,i.setRenderTarget(E,y,L)};function M(w,C){const P=e.update(_);p.defines.VSM_SAMPLES!==w.blurSamples&&(p.defines.VSM_SAMPLES=w.blurSamples,m.defines.VSM_SAMPLES=w.blurSamples,p.needsUpdate=!0,m.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new ei(r.x,r.y)),p.uniforms.shadow_pass.value=w.map.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,i.setRenderTarget(w.mapPass),i.clear(),i.renderBufferDirect(C,null,P,p,_,null),m.uniforms.shadow_pass.value=w.mapPass.texture,m.uniforms.resolution.value=w.mapSize,m.uniforms.radius.value=w.radius,i.setRenderTarget(w.map),i.clear(),i.renderBufferDirect(C,null,P,m,_,null)}function v(w,C,P,E){let y=null;const L=P.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(L!==void 0)y=L;else if(y=P.isPointLight===!0?l:a,i.localClippingEnabled&&C.clipShadows===!0&&Array.isArray(C.clippingPlanes)&&C.clippingPlanes.length!==0||C.displacementMap&&C.displacementScale!==0||C.alphaMap&&C.alphaTest>0||C.map&&C.alphaTest>0||C.alphaToCoverage===!0){const N=y.uuid,V=C.uuid;let I=c[N];I===void 0&&(I={},c[N]=I);let F=I[V];F===void 0&&(F=y.clone(),I[V]=F,C.addEventListener("dispose",R)),y=F}if(y.visible=C.visible,y.wireframe=C.wireframe,E===vn?y.side=C.shadowSide!==null?C.shadowSide:C.side:y.side=C.shadowSide!==null?C.shadowSide:h[C.side],y.alphaMap=C.alphaMap,y.alphaTest=C.alphaToCoverage===!0?.5:C.alphaTest,y.map=C.map,y.clipShadows=C.clipShadows,y.clippingPlanes=C.clippingPlanes,y.clipIntersection=C.clipIntersection,y.displacementMap=C.displacementMap,y.displacementScale=C.displacementScale,y.displacementBias=C.displacementBias,y.wireframeLinewidth=C.wireframeLinewidth,y.linewidth=C.linewidth,P.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const N=i.properties.get(y);N.light=P}return y}function x(w,C,P,E,y){if(w.visible===!1)return;if(w.layers.test(C.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&y===vn)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,w.matrixWorld);const V=e.update(w),I=w.material;if(Array.isArray(I)){const F=V.groups;for(let K=0,j=F.length;K<j;K++){const G=F[K],ce=I[G.materialIndex];if(ce&&ce.visible){const pe=v(w,ce,E,y);w.onBeforeShadow(i,w,C,P,V,pe,G),i.renderBufferDirect(P,null,V,pe,w,G),w.onAfterShadow(i,w,C,P,V,pe,G)}}}else if(I.visible){const F=v(w,I,E,y);w.onBeforeShadow(i,w,C,P,V,F,null),i.renderBufferDirect(P,null,V,F,w,null),w.onAfterShadow(i,w,C,P,V,F,null)}}const N=w.children;for(let V=0,I=N.length;V<I;V++)x(N[V],C,P,E,y)}function R(w){w.target.removeEventListener("dispose",R);for(const P in c){const E=c[P],y=w.target.uuid;y in E&&(E[y].dispose(),delete E[y])}}}const Fg={[eo]:to,[no]:so,[io]:oo,[Ai]:ro,[to]:eo,[so]:no,[oo]:io,[ro]:Ai};function Og(i,e){function t(){let U=!1;const ae=new ht;let fe=null;const ye=new ht(0,0,0,0);return{setMask:function(re){fe!==re&&!U&&(i.colorMask(re,re,re,re),fe=re)},setLocked:function(re){U=re},setClear:function(re,Q,we,ke,rt){rt===!0&&(re*=ke,Q*=ke,we*=ke),ae.set(re,Q,we,ke),ye.equals(ae)===!1&&(i.clearColor(re,Q,we,ke),ye.copy(ae))},reset:function(){U=!1,fe=null,ye.set(-1,0,0,0)}}}function n(){let U=!1,ae=!1,fe=null,ye=null,re=null;return{setReversed:function(Q){if(ae!==Q){const we=e.get("EXT_clip_control");Q?we.clipControlEXT(we.LOWER_LEFT_EXT,we.ZERO_TO_ONE_EXT):we.clipControlEXT(we.LOWER_LEFT_EXT,we.NEGATIVE_ONE_TO_ONE_EXT),ae=Q;const ke=re;re=null,this.setClear(ke)}},getReversed:function(){return ae},setTest:function(Q){Q?te(i.DEPTH_TEST):Me(i.DEPTH_TEST)},setMask:function(Q){fe!==Q&&!U&&(i.depthMask(Q),fe=Q)},setFunc:function(Q){if(ae&&(Q=Fg[Q]),ye!==Q){switch(Q){case eo:i.depthFunc(i.NEVER);break;case to:i.depthFunc(i.ALWAYS);break;case no:i.depthFunc(i.LESS);break;case Ai:i.depthFunc(i.LEQUAL);break;case io:i.depthFunc(i.EQUAL);break;case ro:i.depthFunc(i.GEQUAL);break;case so:i.depthFunc(i.GREATER);break;case oo:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}ye=Q}},setLocked:function(Q){U=Q},setClear:function(Q){re!==Q&&(ae&&(Q=1-Q),i.clearDepth(Q),re=Q)},reset:function(){U=!1,fe=null,ye=null,re=null,ae=!1}}}function r(){let U=!1,ae=null,fe=null,ye=null,re=null,Q=null,we=null,ke=null,rt=null;return{setTest:function($e){U||($e?te(i.STENCIL_TEST):Me(i.STENCIL_TEST))},setMask:function($e){ae!==$e&&!U&&(i.stencilMask($e),ae=$e)},setFunc:function($e,fn,rn){(fe!==$e||ye!==fn||re!==rn)&&(i.stencilFunc($e,fn,rn),fe=$e,ye=fn,re=rn)},setOp:function($e,fn,rn){(Q!==$e||we!==fn||ke!==rn)&&(i.stencilOp($e,fn,rn),Q=$e,we=fn,ke=rn)},setLocked:function($e){U=$e},setClear:function($e){rt!==$e&&(i.clearStencil($e),rt=$e)},reset:function(){U=!1,ae=null,fe=null,ye=null,re=null,Q=null,we=null,ke=null,rt=null}}}const s=new t,o=new n,a=new r,l=new WeakMap,c=new WeakMap;let u={},h={},p=new WeakMap,m=[],g=null,_=!1,d=null,f=null,M=null,v=null,x=null,R=null,w=null,C=new Ke(0,0,0),P=0,E=!1,y=null,L=null,N=null,V=null,I=null;const F=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let K=!1,j=0;const G=i.getParameter(i.VERSION);G.indexOf("WebGL")!==-1?(j=parseFloat(/^WebGL (\d)/.exec(G)[1]),K=j>=1):G.indexOf("OpenGL ES")!==-1&&(j=parseFloat(/^OpenGL ES (\d)/.exec(G)[1]),K=j>=2);let ce=null,pe={};const xe=i.getParameter(i.SCISSOR_BOX),le=i.getParameter(i.VIEWPORT),Ie=new ht().fromArray(xe),We=new ht().fromArray(le);function Le(U,ae,fe,ye){const re=new Uint8Array(4),Q=i.createTexture();i.bindTexture(U,Q),i.texParameteri(U,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(U,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let we=0;we<fe;we++)U===i.TEXTURE_3D||U===i.TEXTURE_2D_ARRAY?i.texImage3D(ae,0,i.RGBA,1,1,ye,0,i.RGBA,i.UNSIGNED_BYTE,re):i.texImage2D(ae+we,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,re);return Q}const Z={};Z[i.TEXTURE_2D]=Le(i.TEXTURE_2D,i.TEXTURE_2D,1),Z[i.TEXTURE_CUBE_MAP]=Le(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[i.TEXTURE_2D_ARRAY]=Le(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),Z[i.TEXTURE_3D]=Le(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),te(i.DEPTH_TEST),o.setFunc(Ai),B(!1),Y(va),te(i.CULL_FACE),$(Un);function te(U){u[U]!==!0&&(i.enable(U),u[U]=!0)}function Me(U){u[U]!==!1&&(i.disable(U),u[U]=!1)}function Ce(U,ae){return h[U]!==ae?(i.bindFramebuffer(U,ae),h[U]=ae,U===i.DRAW_FRAMEBUFFER&&(h[i.FRAMEBUFFER]=ae),U===i.FRAMEBUFFER&&(h[i.DRAW_FRAMEBUFFER]=ae),!0):!1}function Ee(U,ae){let fe=m,ye=!1;if(U){fe=p.get(ae),fe===void 0&&(fe=[],p.set(ae,fe));const re=U.textures;if(fe.length!==re.length||fe[0]!==i.COLOR_ATTACHMENT0){for(let Q=0,we=re.length;Q<we;Q++)fe[Q]=i.COLOR_ATTACHMENT0+Q;fe.length=re.length,ye=!0}}else fe[0]!==i.BACK&&(fe[0]=i.BACK,ye=!0);ye&&i.drawBuffers(fe)}function Xe(U){return g!==U?(i.useProgram(U),g=U,!0):!1}const je={[Yn]:i.FUNC_ADD,[Kl]:i.FUNC_SUBTRACT,[Jl]:i.FUNC_REVERSE_SUBTRACT};je[Zl]=i.MIN,je[jl]=i.MAX;const b={[$l]:i.ZERO,[Ql]:i.ONE,[eu]:i.SRC_COLOR,[$s]:i.SRC_ALPHA,[ou]:i.SRC_ALPHA_SATURATE,[ru]:i.DST_COLOR,[nu]:i.DST_ALPHA,[tu]:i.ONE_MINUS_SRC_COLOR,[Qs]:i.ONE_MINUS_SRC_ALPHA,[su]:i.ONE_MINUS_DST_COLOR,[iu]:i.ONE_MINUS_DST_ALPHA,[au]:i.CONSTANT_COLOR,[cu]:i.ONE_MINUS_CONSTANT_COLOR,[lu]:i.CONSTANT_ALPHA,[uu]:i.ONE_MINUS_CONSTANT_ALPHA};function $(U,ae,fe,ye,re,Q,we,ke,rt,$e){if(U===Un){_===!0&&(Me(i.BLEND),_=!1);return}if(_===!1&&(te(i.BLEND),_=!0),U!==Yl){if(U!==d||$e!==E){if((f!==Yn||x!==Yn)&&(i.blendEquation(i.FUNC_ADD),f=Yn,x=Yn),$e)switch(U){case Ei:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case xa:i.blendFunc(i.ONE,i.ONE);break;case Ma:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Sa:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}else switch(U){case Ei:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case xa:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Ma:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Sa:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",U);break}M=null,v=null,R=null,w=null,C.set(0,0,0),P=0,d=U,E=$e}return}re=re||ae,Q=Q||fe,we=we||ye,(ae!==f||re!==x)&&(i.blendEquationSeparate(je[ae],je[re]),f=ae,x=re),(fe!==M||ye!==v||Q!==R||we!==w)&&(i.blendFuncSeparate(b[fe],b[ye],b[Q],b[we]),M=fe,v=ye,R=Q,w=we),(ke.equals(C)===!1||rt!==P)&&(i.blendColor(ke.r,ke.g,ke.b,rt),C.copy(ke),P=rt),d=U,E=!1}function H(U,ae){U.side===xn?Me(i.CULL_FACE):te(i.CULL_FACE);let fe=U.side===Rt;ae&&(fe=!fe),B(fe),U.blending===Ei&&U.transparent===!1?$(Un):$(U.blending,U.blendEquation,U.blendSrc,U.blendDst,U.blendEquationAlpha,U.blendSrcAlpha,U.blendDstAlpha,U.blendColor,U.blendAlpha,U.premultipliedAlpha),o.setFunc(U.depthFunc),o.setTest(U.depthTest),o.setMask(U.depthWrite),s.setMask(U.colorWrite);const ye=U.stencilWrite;a.setTest(ye),ye&&(a.setMask(U.stencilWriteMask),a.setFunc(U.stencilFunc,U.stencilRef,U.stencilFuncMask),a.setOp(U.stencilFail,U.stencilZFail,U.stencilZPass)),ne(U.polygonOffset,U.polygonOffsetFactor,U.polygonOffsetUnits),U.alphaToCoverage===!0?te(i.SAMPLE_ALPHA_TO_COVERAGE):Me(i.SAMPLE_ALPHA_TO_COVERAGE)}function B(U){y!==U&&(U?i.frontFace(i.CW):i.frontFace(i.CCW),y=U)}function Y(U){U!==Xl?(te(i.CULL_FACE),U!==L&&(U===va?i.cullFace(i.BACK):U===ql?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):Me(i.CULL_FACE),L=U}function oe(U){U!==N&&(K&&i.lineWidth(U),N=U)}function ne(U,ae,fe){U?(te(i.POLYGON_OFFSET_FILL),(V!==ae||I!==fe)&&(i.polygonOffset(ae,fe),V=ae,I=fe)):Me(i.POLYGON_OFFSET_FILL)}function ue(U){U?te(i.SCISSOR_TEST):Me(i.SCISSOR_TEST)}function ze(U){U===void 0&&(U=i.TEXTURE0+F-1),ce!==U&&(i.activeTexture(U),ce=U)}function Ne(U,ae,fe){fe===void 0&&(ce===null?fe=i.TEXTURE0+F-1:fe=ce);let ye=pe[fe];ye===void 0&&(ye={type:void 0,texture:void 0},pe[fe]=ye),(ye.type!==U||ye.texture!==ae)&&(ce!==fe&&(i.activeTexture(fe),ce=fe),i.bindTexture(U,ae||Z[U]),ye.type=U,ye.texture=ae)}function A(){const U=pe[ce];U!==void 0&&U.type!==void 0&&(i.bindTexture(U.type,null),U.type=void 0,U.texture=void 0)}function S(){try{i.compressedTexImage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function O(){try{i.compressedTexImage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function X(){try{i.texSubImage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ee(){try{i.texSubImage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function J(){try{i.compressedTexSubImage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Re(){try{i.compressedTexSubImage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function he(){try{i.texStorage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function Ae(){try{i.texStorage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function be(){try{i.texImage2D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ie(){try{i.texImage3D(...arguments)}catch(U){console.error("THREE.WebGLState:",U)}}function ve(U){Ie.equals(U)===!1&&(i.scissor(U.x,U.y,U.z,U.w),Ie.copy(U))}function Oe(U){We.equals(U)===!1&&(i.viewport(U.x,U.y,U.z,U.w),We.copy(U))}function Pe(U,ae){let fe=c.get(ae);fe===void 0&&(fe=new WeakMap,c.set(ae,fe));let ye=fe.get(U);ye===void 0&&(ye=i.getUniformBlockIndex(ae,U.name),fe.set(U,ye))}function ge(U,ae){const ye=c.get(ae).get(U);l.get(ae)!==ye&&(i.uniformBlockBinding(ae,ye,U.__bindingPointIndex),l.set(ae,ye))}function He(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),o.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),u={},ce=null,pe={},h={},p=new WeakMap,m=[],g=null,_=!1,d=null,f=null,M=null,v=null,x=null,R=null,w=null,C=new Ke(0,0,0),P=0,E=!1,y=null,L=null,N=null,V=null,I=null,Ie.set(0,0,i.canvas.width,i.canvas.height),We.set(0,0,i.canvas.width,i.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:te,disable:Me,bindFramebuffer:Ce,drawBuffers:Ee,useProgram:Xe,setBlending:$,setMaterial:H,setFlipSided:B,setCullFace:Y,setLineWidth:oe,setPolygonOffset:ne,setScissorTest:ue,activeTexture:ze,bindTexture:Ne,unbindTexture:A,compressedTexImage2D:S,compressedTexImage3D:O,texImage2D:be,texImage3D:ie,updateUBOMapping:Pe,uniformBlockBinding:ge,texStorage2D:he,texStorage3D:Ae,texSubImage2D:X,texSubImage3D:ee,compressedTexSubImage2D:J,compressedTexSubImage3D:Re,scissor:ve,viewport:Oe,reset:He}}function Bg(i,e,t,n,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new de,u=new WeakMap;let h;const p=new WeakMap;let m=!1;try{m=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,S){return m?new OffscreenCanvas(A,S):es("canvas")}function _(A,S,O){let X=1;const ee=Ne(A);if((ee.width>O||ee.height>O)&&(X=O/Math.max(ee.width,ee.height)),X<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const J=Math.floor(X*ee.width),Re=Math.floor(X*ee.height);h===void 0&&(h=g(J,Re));const he=S?g(J,Re):h;return he.width=J,he.height=Re,he.getContext("2d").drawImage(A,0,0,J,Re),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ee.width+"x"+ee.height+") to ("+J+"x"+Re+")."),he}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ee.width+"x"+ee.height+")."),A;return A}function d(A){return A.generateMipmaps}function f(A){i.generateMipmap(A)}function M(A){return A.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?i.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function v(A,S,O,X,ee=!1){if(A!==null){if(i[A]!==void 0)return i[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let J=S;if(S===i.RED&&(O===i.FLOAT&&(J=i.R32F),O===i.HALF_FLOAT&&(J=i.R16F),O===i.UNSIGNED_BYTE&&(J=i.R8)),S===i.RED_INTEGER&&(O===i.UNSIGNED_BYTE&&(J=i.R8UI),O===i.UNSIGNED_SHORT&&(J=i.R16UI),O===i.UNSIGNED_INT&&(J=i.R32UI),O===i.BYTE&&(J=i.R8I),O===i.SHORT&&(J=i.R16I),O===i.INT&&(J=i.R32I)),S===i.RG&&(O===i.FLOAT&&(J=i.RG32F),O===i.HALF_FLOAT&&(J=i.RG16F),O===i.UNSIGNED_BYTE&&(J=i.RG8)),S===i.RG_INTEGER&&(O===i.UNSIGNED_BYTE&&(J=i.RG8UI),O===i.UNSIGNED_SHORT&&(J=i.RG16UI),O===i.UNSIGNED_INT&&(J=i.RG32UI),O===i.BYTE&&(J=i.RG8I),O===i.SHORT&&(J=i.RG16I),O===i.INT&&(J=i.RG32I)),S===i.RGB_INTEGER&&(O===i.UNSIGNED_BYTE&&(J=i.RGB8UI),O===i.UNSIGNED_SHORT&&(J=i.RGB16UI),O===i.UNSIGNED_INT&&(J=i.RGB32UI),O===i.BYTE&&(J=i.RGB8I),O===i.SHORT&&(J=i.RGB16I),O===i.INT&&(J=i.RGB32I)),S===i.RGBA_INTEGER&&(O===i.UNSIGNED_BYTE&&(J=i.RGBA8UI),O===i.UNSIGNED_SHORT&&(J=i.RGBA16UI),O===i.UNSIGNED_INT&&(J=i.RGBA32UI),O===i.BYTE&&(J=i.RGBA8I),O===i.SHORT&&(J=i.RGBA16I),O===i.INT&&(J=i.RGBA32I)),S===i.RGB&&(O===i.UNSIGNED_INT_5_9_9_9_REV&&(J=i.RGB9_E5),O===i.UNSIGNED_INT_10F_11F_11F_REV&&(J=i.R11F_G11F_B10F)),S===i.RGBA){const Re=ee?$r:Ze.getTransfer(X);O===i.FLOAT&&(J=i.RGBA32F),O===i.HALF_FLOAT&&(J=i.RGBA16F),O===i.UNSIGNED_BYTE&&(J=Re===tt?i.SRGB8_ALPHA8:i.RGBA8),O===i.UNSIGNED_SHORT_4_4_4_4&&(J=i.RGBA4),O===i.UNSIGNED_SHORT_5_5_5_1&&(J=i.RGB5_A1)}return(J===i.R16F||J===i.R32F||J===i.RG16F||J===i.RG32F||J===i.RGBA16F||J===i.RGBA32F)&&e.get("EXT_color_buffer_float"),J}function x(A,S){let O;return A?S===null||S===Qn||S===ir?O=i.DEPTH24_STENCIL8:S===an?O=i.DEPTH32F_STENCIL8:S===nr&&(O=i.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===Qn||S===ir?O=i.DEPTH_COMPONENT24:S===an?O=i.DEPTH_COMPONENT32F:S===nr&&(O=i.DEPTH_COMPONENT16),O}function R(A,S){return d(A)===!0||A.isFramebufferTexture&&A.minFilter!==zt&&A.minFilter!==on?Math.log2(Math.max(S.width,S.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?S.mipmaps.length:1}function w(A){const S=A.target;S.removeEventListener("dispose",w),P(S),S.isVideoTexture&&u.delete(S)}function C(A){const S=A.target;S.removeEventListener("dispose",C),y(S)}function P(A){const S=n.get(A);if(S.__webglInit===void 0)return;const O=A.source,X=p.get(O);if(X){const ee=X[S.__cacheKey];ee.usedTimes--,ee.usedTimes===0&&E(A),Object.keys(X).length===0&&p.delete(O)}n.remove(A)}function E(A){const S=n.get(A);i.deleteTexture(S.__webglTexture);const O=A.source,X=p.get(O);delete X[S.__cacheKey],o.memory.textures--}function y(A){const S=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let X=0;X<6;X++){if(Array.isArray(S.__webglFramebuffer[X]))for(let ee=0;ee<S.__webglFramebuffer[X].length;ee++)i.deleteFramebuffer(S.__webglFramebuffer[X][ee]);else i.deleteFramebuffer(S.__webglFramebuffer[X]);S.__webglDepthbuffer&&i.deleteRenderbuffer(S.__webglDepthbuffer[X])}else{if(Array.isArray(S.__webglFramebuffer))for(let X=0;X<S.__webglFramebuffer.length;X++)i.deleteFramebuffer(S.__webglFramebuffer[X]);else i.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&i.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&i.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let X=0;X<S.__webglColorRenderbuffer.length;X++)S.__webglColorRenderbuffer[X]&&i.deleteRenderbuffer(S.__webglColorRenderbuffer[X]);S.__webglDepthRenderbuffer&&i.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const O=A.textures;for(let X=0,ee=O.length;X<ee;X++){const J=n.get(O[X]);J.__webglTexture&&(i.deleteTexture(J.__webglTexture),o.memory.textures--),n.remove(O[X])}n.remove(A)}let L=0;function N(){L=0}function V(){const A=L;return A>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+r.maxTextures),L+=1,A}function I(A){const S=[];return S.push(A.wrapS),S.push(A.wrapT),S.push(A.wrapR||0),S.push(A.magFilter),S.push(A.minFilter),S.push(A.anisotropy),S.push(A.internalFormat),S.push(A.format),S.push(A.type),S.push(A.generateMipmaps),S.push(A.premultiplyAlpha),S.push(A.flipY),S.push(A.unpackAlignment),S.push(A.colorSpace),S.join()}function F(A,S){const O=n.get(A);if(A.isVideoTexture&&ue(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&O.__version!==A.version){const X=A.image;if(X===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(X.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Z(O,A,S);return}}else A.isExternalTexture&&(O.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,O.__webglTexture,i.TEXTURE0+S)}function K(A,S){const O=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){Z(O,A,S);return}t.bindTexture(i.TEXTURE_2D_ARRAY,O.__webglTexture,i.TEXTURE0+S)}function j(A,S){const O=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&O.__version!==A.version){Z(O,A,S);return}t.bindTexture(i.TEXTURE_3D,O.__webglTexture,i.TEXTURE0+S)}function G(A,S){const O=n.get(A);if(A.version>0&&O.__version!==A.version){te(O,A,S);return}t.bindTexture(i.TEXTURE_CUBE_MAP,O.__webglTexture,i.TEXTURE0+S)}const ce={[jr]:i.REPEAT,[Jn]:i.CLAMP_TO_EDGE,[lo]:i.MIRRORED_REPEAT},pe={[zt]:i.NEAREST,[xu]:i.NEAREST_MIPMAP_NEAREST,[_r]:i.NEAREST_MIPMAP_LINEAR,[on]:i.LINEAR,[vs]:i.LINEAR_MIPMAP_NEAREST,[Zn]:i.LINEAR_MIPMAP_LINEAR},xe={[Eu]:i.NEVER,[Cu]:i.ALWAYS,[Tu]:i.LESS,[Yc]:i.LEQUAL,[Au]:i.EQUAL,[Ru]:i.GEQUAL,[bu]:i.GREATER,[wu]:i.NOTEQUAL};function le(A,S){if(S.type===an&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===on||S.magFilter===vs||S.magFilter===_r||S.magFilter===Zn||S.minFilter===on||S.minFilter===vs||S.minFilter===_r||S.minFilter===Zn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(A,i.TEXTURE_WRAP_S,ce[S.wrapS]),i.texParameteri(A,i.TEXTURE_WRAP_T,ce[S.wrapT]),(A===i.TEXTURE_3D||A===i.TEXTURE_2D_ARRAY)&&i.texParameteri(A,i.TEXTURE_WRAP_R,ce[S.wrapR]),i.texParameteri(A,i.TEXTURE_MAG_FILTER,pe[S.magFilter]),i.texParameteri(A,i.TEXTURE_MIN_FILTER,pe[S.minFilter]),S.compareFunction&&(i.texParameteri(A,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(A,i.TEXTURE_COMPARE_FUNC,xe[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===zt||S.minFilter!==_r&&S.minFilter!==Zn||S.type===an&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||n.get(S).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");i.texParameterf(A,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),n.get(S).__currentAnisotropy=S.anisotropy}}}function Ie(A,S){let O=!1;A.__webglInit===void 0&&(A.__webglInit=!0,S.addEventListener("dispose",w));const X=S.source;let ee=p.get(X);ee===void 0&&(ee={},p.set(X,ee));const J=I(S);if(J!==A.__cacheKey){ee[J]===void 0&&(ee[J]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,O=!0),ee[J].usedTimes++;const Re=ee[A.__cacheKey];Re!==void 0&&(ee[A.__cacheKey].usedTimes--,Re.usedTimes===0&&E(S)),A.__cacheKey=J,A.__webglTexture=ee[J].texture}return O}function We(A,S,O){return Math.floor(Math.floor(A/O)/S)}function Le(A,S,O,X){const J=A.updateRanges;if(J.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,S.width,S.height,O,X,S.data);else{J.sort((ie,ve)=>ie.start-ve.start);let Re=0;for(let ie=1;ie<J.length;ie++){const ve=J[Re],Oe=J[ie],Pe=ve.start+ve.count,ge=We(Oe.start,S.width,4),He=We(ve.start,S.width,4);Oe.start<=Pe+1&&ge===He&&We(Oe.start+Oe.count-1,S.width,4)===ge?ve.count=Math.max(ve.count,Oe.start+Oe.count-ve.start):(++Re,J[Re]=Oe)}J.length=Re+1;const he=i.getParameter(i.UNPACK_ROW_LENGTH),Ae=i.getParameter(i.UNPACK_SKIP_PIXELS),be=i.getParameter(i.UNPACK_SKIP_ROWS);i.pixelStorei(i.UNPACK_ROW_LENGTH,S.width);for(let ie=0,ve=J.length;ie<ve;ie++){const Oe=J[ie],Pe=Math.floor(Oe.start/4),ge=Math.ceil(Oe.count/4),He=Pe%S.width,U=Math.floor(Pe/S.width),ae=ge,fe=1;i.pixelStorei(i.UNPACK_SKIP_PIXELS,He),i.pixelStorei(i.UNPACK_SKIP_ROWS,U),t.texSubImage2D(i.TEXTURE_2D,0,He,U,ae,fe,O,X,S.data)}A.clearUpdateRanges(),i.pixelStorei(i.UNPACK_ROW_LENGTH,he),i.pixelStorei(i.UNPACK_SKIP_PIXELS,Ae),i.pixelStorei(i.UNPACK_SKIP_ROWS,be)}}function Z(A,S,O){let X=i.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(X=i.TEXTURE_2D_ARRAY),S.isData3DTexture&&(X=i.TEXTURE_3D);const ee=Ie(A,S),J=S.source;t.bindTexture(X,A.__webglTexture,i.TEXTURE0+O);const Re=n.get(J);if(J.version!==Re.__version||ee===!0){t.activeTexture(i.TEXTURE0+O);const he=Ze.getPrimaries(Ze.workingColorSpace),Ae=S.colorSpace===In?null:Ze.getPrimaries(S.colorSpace),be=S.colorSpace===In||he===Ae?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,S.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,S.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,be);let ie=_(S.image,!1,r.maxTextureSize);ie=ze(S,ie);const ve=s.convert(S.format,S.colorSpace),Oe=s.convert(S.type);let Pe=v(S.internalFormat,ve,Oe,S.colorSpace,S.isVideoTexture);le(X,S);let ge;const He=S.mipmaps,U=S.isVideoTexture!==!0,ae=Re.__version===void 0||ee===!0,fe=J.dataReady,ye=R(S,ie);if(S.isDepthTexture)Pe=x(S.format===sr,S.type),ae&&(U?t.texStorage2D(i.TEXTURE_2D,1,Pe,ie.width,ie.height):t.texImage2D(i.TEXTURE_2D,0,Pe,ie.width,ie.height,0,ve,Oe,null));else if(S.isDataTexture)if(He.length>0){U&&ae&&t.texStorage2D(i.TEXTURE_2D,ye,Pe,He[0].width,He[0].height);for(let re=0,Q=He.length;re<Q;re++)ge=He[re],U?fe&&t.texSubImage2D(i.TEXTURE_2D,re,0,0,ge.width,ge.height,ve,Oe,ge.data):t.texImage2D(i.TEXTURE_2D,re,Pe,ge.width,ge.height,0,ve,Oe,ge.data);S.generateMipmaps=!1}else U?(ae&&t.texStorage2D(i.TEXTURE_2D,ye,Pe,ie.width,ie.height),fe&&Le(S,ie,ve,Oe)):t.texImage2D(i.TEXTURE_2D,0,Pe,ie.width,ie.height,0,ve,Oe,ie.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){U&&ae&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ye,Pe,He[0].width,He[0].height,ie.depth);for(let re=0,Q=He.length;re<Q;re++)if(ge=He[re],S.format!==Qt)if(ve!==null)if(U){if(fe)if(S.layerUpdates.size>0){const we=rc(ge.width,ge.height,S.format,S.type);for(const ke of S.layerUpdates){const rt=ge.data.subarray(ke*we/ge.data.BYTES_PER_ELEMENT,(ke+1)*we/ge.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,re,0,0,ke,ge.width,ge.height,1,ve,rt)}S.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,re,0,0,0,ge.width,ge.height,ie.depth,ve,ge.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,re,Pe,ge.width,ge.height,ie.depth,0,ge.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else U?fe&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,re,0,0,0,ge.width,ge.height,ie.depth,ve,Oe,ge.data):t.texImage3D(i.TEXTURE_2D_ARRAY,re,Pe,ge.width,ge.height,ie.depth,0,ve,Oe,ge.data)}else{U&&ae&&t.texStorage2D(i.TEXTURE_2D,ye,Pe,He[0].width,He[0].height);for(let re=0,Q=He.length;re<Q;re++)ge=He[re],S.format!==Qt?ve!==null?U?fe&&t.compressedTexSubImage2D(i.TEXTURE_2D,re,0,0,ge.width,ge.height,ve,ge.data):t.compressedTexImage2D(i.TEXTURE_2D,re,Pe,ge.width,ge.height,0,ge.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):U?fe&&t.texSubImage2D(i.TEXTURE_2D,re,0,0,ge.width,ge.height,ve,Oe,ge.data):t.texImage2D(i.TEXTURE_2D,re,Pe,ge.width,ge.height,0,ve,Oe,ge.data)}else if(S.isDataArrayTexture)if(U){if(ae&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ye,Pe,ie.width,ie.height,ie.depth),fe)if(S.layerUpdates.size>0){const re=rc(ie.width,ie.height,S.format,S.type);for(const Q of S.layerUpdates){const we=ie.data.subarray(Q*re/ie.data.BYTES_PER_ELEMENT,(Q+1)*re/ie.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,Q,ie.width,ie.height,1,ve,Oe,we)}S.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,ie.width,ie.height,ie.depth,ve,Oe,ie.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,Pe,ie.width,ie.height,ie.depth,0,ve,Oe,ie.data);else if(S.isData3DTexture)U?(ae&&t.texStorage3D(i.TEXTURE_3D,ye,Pe,ie.width,ie.height,ie.depth),fe&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,ie.width,ie.height,ie.depth,ve,Oe,ie.data)):t.texImage3D(i.TEXTURE_3D,0,Pe,ie.width,ie.height,ie.depth,0,ve,Oe,ie.data);else if(S.isFramebufferTexture){if(ae)if(U)t.texStorage2D(i.TEXTURE_2D,ye,Pe,ie.width,ie.height);else{let re=ie.width,Q=ie.height;for(let we=0;we<ye;we++)t.texImage2D(i.TEXTURE_2D,we,Pe,re,Q,0,ve,Oe,null),re>>=1,Q>>=1}}else if(He.length>0){if(U&&ae){const re=Ne(He[0]);t.texStorage2D(i.TEXTURE_2D,ye,Pe,re.width,re.height)}for(let re=0,Q=He.length;re<Q;re++)ge=He[re],U?fe&&t.texSubImage2D(i.TEXTURE_2D,re,0,0,ve,Oe,ge):t.texImage2D(i.TEXTURE_2D,re,Pe,ve,Oe,ge);S.generateMipmaps=!1}else if(U){if(ae){const re=Ne(ie);t.texStorage2D(i.TEXTURE_2D,ye,Pe,re.width,re.height)}fe&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,ve,Oe,ie)}else t.texImage2D(i.TEXTURE_2D,0,Pe,ve,Oe,ie);d(S)&&f(X),Re.__version=J.version,S.onUpdate&&S.onUpdate(S)}A.__version=S.version}function te(A,S,O){if(S.image.length!==6)return;const X=Ie(A,S),ee=S.source;t.bindTexture(i.TEXTURE_CUBE_MAP,A.__webglTexture,i.TEXTURE0+O);const J=n.get(ee);if(ee.version!==J.__version||X===!0){t.activeTexture(i.TEXTURE0+O);const Re=Ze.getPrimaries(Ze.workingColorSpace),he=S.colorSpace===In?null:Ze.getPrimaries(S.colorSpace),Ae=S.colorSpace===In||Re===he?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,S.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,S.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ae);const be=S.isCompressedTexture||S.image[0].isCompressedTexture,ie=S.image[0]&&S.image[0].isDataTexture,ve=[];for(let Q=0;Q<6;Q++)!be&&!ie?ve[Q]=_(S.image[Q],!0,r.maxCubemapSize):ve[Q]=ie?S.image[Q].image:S.image[Q],ve[Q]=ze(S,ve[Q]);const Oe=ve[0],Pe=s.convert(S.format,S.colorSpace),ge=s.convert(S.type),He=v(S.internalFormat,Pe,ge,S.colorSpace),U=S.isVideoTexture!==!0,ae=J.__version===void 0||X===!0,fe=ee.dataReady;let ye=R(S,Oe);le(i.TEXTURE_CUBE_MAP,S);let re;if(be){U&&ae&&t.texStorage2D(i.TEXTURE_CUBE_MAP,ye,He,Oe.width,Oe.height);for(let Q=0;Q<6;Q++){re=ve[Q].mipmaps;for(let we=0;we<re.length;we++){const ke=re[we];S.format!==Qt?Pe!==null?U?fe&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,we,0,0,ke.width,ke.height,Pe,ke.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,we,He,ke.width,ke.height,0,ke.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,we,0,0,ke.width,ke.height,Pe,ge,ke.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,we,He,ke.width,ke.height,0,Pe,ge,ke.data)}}}else{if(re=S.mipmaps,U&&ae){re.length>0&&ye++;const Q=Ne(ve[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,ye,He,Q.width,Q.height)}for(let Q=0;Q<6;Q++)if(ie){U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,ve[Q].width,ve[Q].height,Pe,ge,ve[Q].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,He,ve[Q].width,ve[Q].height,0,Pe,ge,ve[Q].data);for(let we=0;we<re.length;we++){const rt=re[we].image[Q].image;U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,we+1,0,0,rt.width,rt.height,Pe,ge,rt.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,we+1,He,rt.width,rt.height,0,Pe,ge,rt.data)}}else{U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,0,0,Pe,ge,ve[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,0,He,Pe,ge,ve[Q]);for(let we=0;we<re.length;we++){const ke=re[we];U?fe&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,we+1,0,0,Pe,ge,ke.image[Q]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+Q,we+1,He,Pe,ge,ke.image[Q])}}}d(S)&&f(i.TEXTURE_CUBE_MAP),J.__version=ee.version,S.onUpdate&&S.onUpdate(S)}A.__version=S.version}function Me(A,S,O,X,ee,J){const Re=s.convert(O.format,O.colorSpace),he=s.convert(O.type),Ae=v(O.internalFormat,Re,he,O.colorSpace),be=n.get(S),ie=n.get(O);if(ie.__renderTarget=S,!be.__hasExternalTextures){const ve=Math.max(1,S.width>>J),Oe=Math.max(1,S.height>>J);ee===i.TEXTURE_3D||ee===i.TEXTURE_2D_ARRAY?t.texImage3D(ee,J,Ae,ve,Oe,S.depth,0,Re,he,null):t.texImage2D(ee,J,Ae,ve,Oe,0,Re,he,null)}t.bindFramebuffer(i.FRAMEBUFFER,A),ne(S)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,X,ee,ie.__webglTexture,0,oe(S)):(ee===i.TEXTURE_2D||ee>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&ee<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,X,ee,ie.__webglTexture,J),t.bindFramebuffer(i.FRAMEBUFFER,null)}function Ce(A,S,O){if(i.bindRenderbuffer(i.RENDERBUFFER,A),S.depthBuffer){const X=S.depthTexture,ee=X&&X.isDepthTexture?X.type:null,J=x(S.stencilBuffer,ee),Re=S.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,he=oe(S);ne(S)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,he,J,S.width,S.height):O?i.renderbufferStorageMultisample(i.RENDERBUFFER,he,J,S.width,S.height):i.renderbufferStorage(i.RENDERBUFFER,J,S.width,S.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Re,i.RENDERBUFFER,A)}else{const X=S.textures;for(let ee=0;ee<X.length;ee++){const J=X[ee],Re=s.convert(J.format,J.colorSpace),he=s.convert(J.type),Ae=v(J.internalFormat,Re,he,J.colorSpace),be=oe(S);O&&ne(S)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,be,Ae,S.width,S.height):ne(S)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,be,Ae,S.width,S.height):i.renderbufferStorage(i.RENDERBUFFER,Ae,S.width,S.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function Ee(A,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,A),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const X=n.get(S.depthTexture);X.__renderTarget=S,(!X.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),F(S.depthTexture,0);const ee=X.__webglTexture,J=oe(S);if(S.depthTexture.format===rr)ne(S)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ee,0,J):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,ee,0);else if(S.depthTexture.format===sr)ne(S)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ee,0,J):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,ee,0);else throw new Error("Unknown depthTexture format")}function Xe(A){const S=n.get(A),O=A.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==A.depthTexture){const X=A.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),X){const ee=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,X.removeEventListener("dispose",ee)};X.addEventListener("dispose",ee),S.__depthDisposeCallback=ee}S.__boundDepthTexture=X}if(A.depthTexture&&!S.__autoAllocateDepthBuffer){if(O)throw new Error("target.depthTexture not supported in Cube render targets");const X=A.texture.mipmaps;X&&X.length>0?Ee(S.__webglFramebuffer[0],A):Ee(S.__webglFramebuffer,A)}else if(O){S.__webglDepthbuffer=[];for(let X=0;X<6;X++)if(t.bindFramebuffer(i.FRAMEBUFFER,S.__webglFramebuffer[X]),S.__webglDepthbuffer[X]===void 0)S.__webglDepthbuffer[X]=i.createRenderbuffer(),Ce(S.__webglDepthbuffer[X],A,!1);else{const ee=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=S.__webglDepthbuffer[X];i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,ee,i.RENDERBUFFER,J)}}else{const X=A.texture.mipmaps;if(X&&X.length>0?t.bindFramebuffer(i.FRAMEBUFFER,S.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=i.createRenderbuffer(),Ce(S.__webglDepthbuffer,A,!1);else{const ee=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,J=S.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,J),i.framebufferRenderbuffer(i.FRAMEBUFFER,ee,i.RENDERBUFFER,J)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function je(A,S,O){const X=n.get(A);S!==void 0&&Me(X.__webglFramebuffer,A,A.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),O!==void 0&&Xe(A)}function b(A){const S=A.texture,O=n.get(A),X=n.get(S);A.addEventListener("dispose",C);const ee=A.textures,J=A.isWebGLCubeRenderTarget===!0,Re=ee.length>1;if(Re||(X.__webglTexture===void 0&&(X.__webglTexture=i.createTexture()),X.__version=S.version,o.memory.textures++),J){O.__webglFramebuffer=[];for(let he=0;he<6;he++)if(S.mipmaps&&S.mipmaps.length>0){O.__webglFramebuffer[he]=[];for(let Ae=0;Ae<S.mipmaps.length;Ae++)O.__webglFramebuffer[he][Ae]=i.createFramebuffer()}else O.__webglFramebuffer[he]=i.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){O.__webglFramebuffer=[];for(let he=0;he<S.mipmaps.length;he++)O.__webglFramebuffer[he]=i.createFramebuffer()}else O.__webglFramebuffer=i.createFramebuffer();if(Re)for(let he=0,Ae=ee.length;he<Ae;he++){const be=n.get(ee[he]);be.__webglTexture===void 0&&(be.__webglTexture=i.createTexture(),o.memory.textures++)}if(A.samples>0&&ne(A)===!1){O.__webglMultisampledFramebuffer=i.createFramebuffer(),O.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let he=0;he<ee.length;he++){const Ae=ee[he];O.__webglColorRenderbuffer[he]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,O.__webglColorRenderbuffer[he]);const be=s.convert(Ae.format,Ae.colorSpace),ie=s.convert(Ae.type),ve=v(Ae.internalFormat,be,ie,Ae.colorSpace,A.isXRRenderTarget===!0),Oe=oe(A);i.renderbufferStorageMultisample(i.RENDERBUFFER,Oe,ve,A.width,A.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+he,i.RENDERBUFFER,O.__webglColorRenderbuffer[he])}i.bindRenderbuffer(i.RENDERBUFFER,null),A.depthBuffer&&(O.__webglDepthRenderbuffer=i.createRenderbuffer(),Ce(O.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(J){t.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture),le(i.TEXTURE_CUBE_MAP,S);for(let he=0;he<6;he++)if(S.mipmaps&&S.mipmaps.length>0)for(let Ae=0;Ae<S.mipmaps.length;Ae++)Me(O.__webglFramebuffer[he][Ae],A,S,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+he,Ae);else Me(O.__webglFramebuffer[he],A,S,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+he,0);d(S)&&f(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Re){for(let he=0,Ae=ee.length;he<Ae;he++){const be=ee[he],ie=n.get(be);let ve=i.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ve=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ve,ie.__webglTexture),le(ve,be),Me(O.__webglFramebuffer,A,be,i.COLOR_ATTACHMENT0+he,ve,0),d(be)&&f(ve)}t.unbindTexture()}else{let he=i.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(he=A.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(he,X.__webglTexture),le(he,S),S.mipmaps&&S.mipmaps.length>0)for(let Ae=0;Ae<S.mipmaps.length;Ae++)Me(O.__webglFramebuffer[Ae],A,S,i.COLOR_ATTACHMENT0,he,Ae);else Me(O.__webglFramebuffer,A,S,i.COLOR_ATTACHMENT0,he,0);d(S)&&f(he),t.unbindTexture()}A.depthBuffer&&Xe(A)}function $(A){const S=A.textures;for(let O=0,X=S.length;O<X;O++){const ee=S[O];if(d(ee)){const J=M(A),Re=n.get(ee).__webglTexture;t.bindTexture(J,Re),f(J),t.unbindTexture()}}}const H=[],B=[];function Y(A){if(A.samples>0){if(ne(A)===!1){const S=A.textures,O=A.width,X=A.height;let ee=i.COLOR_BUFFER_BIT;const J=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Re=n.get(A),he=S.length>1;if(he)for(let be=0;be<S.length;be++)t.bindFramebuffer(i.FRAMEBUFFER,Re.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Re.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Re.__webglMultisampledFramebuffer);const Ae=A.texture.mipmaps;Ae&&Ae.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Re.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Re.__webglFramebuffer);for(let be=0;be<S.length;be++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(ee|=i.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(ee|=i.STENCIL_BUFFER_BIT)),he){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Re.__webglColorRenderbuffer[be]);const ie=n.get(S[be]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,ie,0)}i.blitFramebuffer(0,0,O,X,0,0,O,X,ee,i.NEAREST),l===!0&&(H.length=0,B.length=0,H.push(i.COLOR_ATTACHMENT0+be),A.depthBuffer&&A.resolveDepthBuffer===!1&&(H.push(J),B.push(J),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,B)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,H))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),he)for(let be=0;be<S.length;be++){t.bindFramebuffer(i.FRAMEBUFFER,Re.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.RENDERBUFFER,Re.__webglColorRenderbuffer[be]);const ie=n.get(S[be]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Re.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+be,i.TEXTURE_2D,ie,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Re.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&l){const S=A.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[S])}}}function oe(A){return Math.min(r.maxSamples,A.samples)}function ne(A){const S=n.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function ue(A){const S=o.render.frame;u.get(A)!==S&&(u.set(A,S),A.update())}function ze(A,S){const O=A.colorSpace,X=A.format,ee=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||O!==Ri&&O!==In&&(Ze.getTransfer(O)===tt?(X!==Qt||ee!==ln)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",O)),S}function Ne(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(c.width=A.naturalWidth||A.width,c.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(c.width=A.displayWidth,c.height=A.displayHeight):(c.width=A.width,c.height=A.height),c}this.allocateTextureUnit=V,this.resetTextureUnits=N,this.setTexture2D=F,this.setTexture2DArray=K,this.setTexture3D=j,this.setTextureCube=G,this.rebindTextures=je,this.setupRenderTarget=b,this.updateRenderTargetMipmap=$,this.updateMultisampleRenderTarget=Y,this.setupDepthRenderbuffer=Xe,this.setupFrameBufferTexture=Me,this.useMultisampledRTT=ne}function zg(i,e){function t(n,r=In){let s;const o=Ze.getTransfer(r);if(n===ln)return i.UNSIGNED_BYTE;if(n===qo)return i.UNSIGNED_SHORT_4_4_4_4;if(n===Yo)return i.UNSIGNED_SHORT_5_5_5_1;if(n===Hc)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===Vc)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===zc)return i.BYTE;if(n===kc)return i.SHORT;if(n===nr)return i.UNSIGNED_SHORT;if(n===Xo)return i.INT;if(n===Qn)return i.UNSIGNED_INT;if(n===an)return i.FLOAT;if(n===fr)return i.HALF_FLOAT;if(n===Gc)return i.ALPHA;if(n===Wc)return i.RGB;if(n===Qt)return i.RGBA;if(n===rr)return i.DEPTH_COMPONENT;if(n===sr)return i.DEPTH_STENCIL;if(n===Ko)return i.RED;if(n===Jo)return i.RED_INTEGER;if(n===Xc)return i.RG;if(n===Zo)return i.RG_INTEGER;if(n===jo)return i.RGBA_INTEGER;if(n===Wr||n===Xr||n===qr||n===Yr)if(o===tt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Wr)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Xr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===qr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===Yr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Wr)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Xr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===qr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===Yr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===uo||n===ho||n===fo||n===po)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===uo)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===ho)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===fo)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===po)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===mo||n===go||n===_o)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===mo||n===go)return o===tt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===_o)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===vo||n===xo||n===Mo||n===So||n===yo||n===Eo||n===To||n===Ao||n===bo||n===wo||n===Ro||n===Co||n===Po||n===Lo)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===vo)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===xo)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Mo)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===So)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===yo)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Eo)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===To)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ao)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===bo)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===wo)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ro)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Co)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Po)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Lo)return o===tt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===Do||n===Io||n===Uo)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===Do)return o===tt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Io)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Uo)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===No||n===Fo||n===Oo||n===Bo)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===No)return s.COMPRESSED_RED_RGTC1_EXT;if(n===Fo)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Oo)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===Bo)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===ir?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const kg=`
void main() {
